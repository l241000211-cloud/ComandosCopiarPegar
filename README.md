...
* 📁 **[Codigo/](Codigo/script.sh)**: Script de automatización en Bash comentado.
* 📁 **[Terminal/](Terminal/)**: Capturas nítidas de la ejecución de comandos.
* 📁 **[Reporte/](Reporte/practica.pdf)**: Reporte formal en formato PDF con justificación técnica.
...
| ![7](Terminal/7.png)<br><sub>7. Copia recursiva (`cp -r`)</sub> | ![8](Terminal/8.png)<br><sub>8. Borrado (`rm` y `rm -r`) y verificación</sub> | |
